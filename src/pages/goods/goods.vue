...
<template>
      ...
      <view class="preview">
        <swiper circular @change="onChange">
          <swiper-item v-for="picture in goods?.mainPictures" :key="picture">
            <image @tap="onTapImage" mode="aspectFill" :src="picture" />
          </swiper-item>
        </swiper>
  ...
  <uni-popup ref="popup" type="bottom" background-color="#fff">
    <address-pannel v-if="popupName == 'address'" @close="popup?.close()"></address-pannel>
    <service-pannel v-if="popupName == 'service'" @close="popup?.close()"></service-pannel>
  </uni-popup>
</template>
